// src/modules/admin/pages/AdminStates.jsx
  ...
  const handleAddState = async () => {
    ...
    try {
      const { error } = await supabase
        .from('states')
        .insert([{ name: newState.trim(), active: true }]);
      if (error) throw error;
      setNewState('');
      fetchStates();
    } catch (error) {
